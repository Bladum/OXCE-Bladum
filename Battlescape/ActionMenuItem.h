...
private:
	...
	Frame *_frame;
	Text *_txtDescription, *_txtAcc, *_txtTU, *_txtRange, *_txtPow;
public:
	...
	void setAction(BattleActionType action, const std::wstring &description, const std::wstring &power, const std::wstring &accuracy, const std::wstring &timeunits, const std::wstring &range, int tu);
